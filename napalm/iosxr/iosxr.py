    ...
    def get_route_to(self, destination="", protocol=""):
        ...
        if ipv == 6:
            route_info_rpc_command = (
                ...
                "<SAFTable>"
                "<SAF><Naming><SAFName>Unicast</SAFName></Naming><IP_RIBRouteTable><IP_RIBRouteTableName>"
                "<Naming>"
                "<RouteTableName>default</RouteTableName></Naming><RouteTable><Route><Naming>"
                "<Address>"
                "{network}</Address>{prefix}</Naming></Route></RouteTable></IP_RIBRouteTableName>"
            ...
            route_info_rpc_command = (
                ...
                "<SAFTable><SAF>"
                "<Naming><SAFName>Unicast</SAFName></Naming><IP_RIBRouteTable><IP_RIBRouteTableName>"
                "<Naming>"
                "<RouteTableName>default</RouteTableName></Naming><RouteTable><Route><Naming>"
                "<Address>"
                "{network}</Address>{prefix}</Naming></Route></RouteTable></IP_RIBRouteTableName>"
